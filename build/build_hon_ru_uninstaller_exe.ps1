...
# Load C# template
$templatePath = Join-Path $PSScriptRoot "uninstaller_template.cs"
...
$versionNumeric = $version -replace '[a-zA-Z]+$', ''  # strip letter suffix for AssemblyVersion
$versionFull = "$versionNumeric.0"
