...
$startupContent = "@echo off`r`npowershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File `"$agentScript`"`r`n"
...
Write-Host "StartupEntry: $startupCmd"
Write-Host "Agent log: $(Join-Path $dataRoot 'agent.log')"
